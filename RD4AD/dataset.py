...
class CMDataset(torch.utils.Dataset):
    def __init__(self, root, transform, phase):
        ...
        self.img_paths, self.labels, self.types = self.load_dataset() #label => good:0. anomaly:1
    ...
    '''
    이후 load_data 부분 파악 후 우리 데이터 셋에 맞게 코드를 변경해야함
    '''
